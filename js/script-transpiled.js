...
(function () {
	...
	var apiKey = "57d974e138278c3b9fdd0e24652d3b31"; // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
	var activities = {
	...
	document.querySelectorAll('.options div').forEach(function (el) {
		return el.addEventListener('click', updateActivityList, false);
	});
